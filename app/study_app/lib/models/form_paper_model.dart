...
class FormPaperModel {
  ...
  factory FormPaperModel.fromString(String jsonString) =>
      FormPaperModel.fromJson(json.decode(jsonString));

  FormPaperModel.fromJson(Map<String, dynamic> json)
      : id = json['id'],
  ...
  FormPaperModel.fromSnapshot(DocumentSnapshot<Map<String, dynamic>> snapshot)
      : id = snapshot.id,
